...
export class ProductService {
    ...
    getProducts() {
        return this.http.get('http://localhost:9010/api/v1/products', this.jwt());
    }

    getProduct(id) {
       return this.http.get('http://localhost:9010/api/v1/product/'+id, this.jwt());
    }
    ...
    private jwt() {
        ...
        'Content-Type': 'application/json'},
            ...
            return null; //new HttpRequest({ headers: 'headers' });
        }
    }
